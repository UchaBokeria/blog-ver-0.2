...
CREATE TABLE `files`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 12123372 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `files` VALUES (12123371, 'Array', NULL, NULL, NULL, 184, 0, 0, NULL, NULL);
